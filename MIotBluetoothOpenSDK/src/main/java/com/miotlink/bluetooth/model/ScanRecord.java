            ...
            while (currentPos < scanRecord.length) {
                ...
                switch (fieldType) {
                    ...
                    case DATA_TYPE_MANUFACTURER_SPECIFIC_DATA:
                        int manufacturerId = ((scanRecord[currentPos] << 8)) + ((scanRecord[currentPos + 1] & 0xFF));
                        byte[] manufacturerDataBytes = extractBytes(scanRecord, currentPos, dataLength);
...
//            BleLog.e(TAG, "unable to parse scan record: " + Arrays.toString(scanRecord));
    ...
    public String toString() {
        return "ScanRecord [mAdvertiseFlags=" + mAdvertiseFlags + ", mServiceUuids=" + mServiceUuids
                + ", mManufacturerSpecificData=" + ScanRecord.toString(mManufacturerSpecificData)
                + ", mServiceData=" + ScanRecord.toString(mServiceData)
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeSparseArray((SparseArray) this.mManufacturerSpecificData);
    ...
    protected ScanRecord(Parcel in) {
        this.mAdvertiseFlags = in.readInt();
        this.mServiceUuids = in.createTypedArrayList(ParcelUuid.CREATOR);
        this.mManufacturerSpecificData = in.readSparseArray(byte[].class.getClassLoader());
        int mServiceDataSize = in.readInt();
        this.mServiceData = new HashMap<ParcelUuid, byte[]>(mServiceDataSize);
    ...
    public static final Creator<ScanRecord> CREATOR = new Creator<ScanRecord>() {
        @Override
