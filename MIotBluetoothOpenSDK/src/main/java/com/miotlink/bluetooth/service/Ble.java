...
import com.miotlink.bluetooth.callback.BleStatusCallback;
...
import com.miotlink.bluetooth.callback.wrapper.BluetoothChangedObserver;
...
import com.miotlink.bluetooth.proxy.RequestImpl;
import com.miotlink.bluetooth.proxy.RequestListener;
import com.miotlink.bluetooth.proxy.RequestProxy;
import com.miotlink.bluetooth.queue.RequestTask;
import com.miotlink.bluetooth.queue.WriteQueue;
...
public final class Ble<T extends BleDevice> {
    ...
    public interface InitCallback {
        void initialization(int error,String errorMessage);
    }
    ...
    public void init(Context context, Options options, InitCallback callback) {
        ...
        if (this.context != null){
            ...
            if (callback != null){
                callback.initialization(BleStates.InitAlready,"Ble is Initialized");
            }
            return;
        }
        ...
        if (bluetoothAdapter == null){
            if (callback != null){
                ...
                callback.initialization(BleStates.NotAvailable,"bluetoothAdapter is not available!");
            }
            return;
        }
        if (!isSupportBle(context)){
            if (callback != null){
                ...
                callback.initialization(BleStates.NotSupportBLE,"not support ble");
            }
            return;
        }
        ...
        if (callback != null){
            callback.initialization(BleStates.InitSUCCESS,"INIT SUCCESS");
        }
    }
    ...
    public T getConnectedDevice(String address) {
        ConnectRequest<T> request = Rproxy.getRequest(ConnectRequest.class);
        return request.getConnectedDevice(address);
    }
