...
public class BlueTools {
    ...
    static public byte[] int16ToBytes(int n) {
    ...
    static public byte[] Long32ToBytesLE(long n, byte[] buff, int startPos) {
        buff[startPos + 3] = (byte) (n / 16777216);
        buff[startPos + 2] = (byte) ((n % 16777216) / 65536);
        buff[startPos + 1] = (byte) ((n % 65536) / 256);
        buff[startPos] = (byte) (n % 256);
    ...
    static public byte[] Long32ToBytesUP(long n, byte[] buff, int startPos) {
        buff[startPos] = (byte) (n / 16777216);
        buff[startPos + 1] = (byte) ((n % 16777216) / 65536);
        buff[startPos + 2] = (byte) ((n % 65536) / 256);
        buff[startPos+3] = (byte) (n % 256);
        return buff;
    }
    static public byte[] Int32ToBytesUP(int n, byte[] buff, int startPos) {
        buff[startPos] = (byte) (n / 16777216);
        buff[startPos +1] = (byte) ((n % 16777216) / 65536);
        buff[startPos +2] = (byte) ((n % 65536) / 256);
        buff[startPos+3] = (byte) (n % 256);
